      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-6 pt-20 pb-20 text-center sm:pt-28">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-neutral-600 sm:text-xl">
            Listens to the patient conversation. Writes the SOAP note. Cuts physicians&apos;
            documentation time by 75%.
          </p>
          ...
          <div className="mt-12">
            <div className="mx-auto max-w-3xl grid gap-5 md:grid-cols-2">
              <div className="rounded-3xl border border-neutral-200 bg-white p-5">
                ...
                <div className="space-y-2 text-sm italic text-neutral-700">
                  <p>&ldquo;It&apos;s mostly a dull ache, but sometimes it stabs when I turn my head…&rdquo;</p>
                  <p>&ldquo;Started about three weeks ago, after I tried a new pillow…&rdquo;</p>
                  <p>&ldquo;I&apos;ve been taking ibuprofen, 400 mg, twice a day…&rdquo;</p>
                </div>
              </div>
              <div className="rounded-3xl border border-neutral-200 bg-white p-5">
                <div className="mb-2 text-xs font-semibold uppercase tracking-wider text-cyan-600">
                ...
                <div className="space-y-2 text-sm text-neutral-800">
                  <div>
                    <strong>S:</strong> Pt reports 3 wks of cervical pain, dull with intermittent
                    stabbing on rotation. Onset post-pillow change. Ibuprofen 400mg BID with partial
                    relief.
                  </div>
                  <div>
                    <strong>O:</strong> Neck ROM limited on R rotation. No focal neuro deficits.
                  </div>
                  <div>
                    <strong>A:</strong> Likely mechanical cervicalgia.
                  </div>
                  <div>
                    <strong>P:</strong> Stretching program, pillow recommendation, NSAIDs PRN, f/u 2
                    wks.
                  </div>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-12 grid gap-12 sm:grid-cols-3">
            <div>
              ...
              <h3 className="mt-4 text-lg font-semibold tracking-tight">HIPAA-compliant</h3>
              <p className="mt-2 leading-relaxed text-neutral-600">
                Audio never leaves the device unencrypted. We&apos;re BAA-ready on day one.
              </p>
            </div>
            <div>
              <div className="text-3xl">📋</div>
              <h3 className="mt-4 text-lg font-semibold tracking-tight">Fills your EHR</h3>
              <p className="mt-2 leading-relaxed text-neutral-600">
                Epic, Athena, eClinicalWorks. The note lands where it needs to be.
              </p>
            </div>
            <div>
              <div className="text-3xl">⏱️</div>
              <h3 className="mt-4 text-lg font-semibold tracking-tight">Two hours back per day</h3>
              <p className="mt-2 leading-relaxed text-neutral-600">
                Average physician saves 90 minutes of charting. Spend it on patients or sleep.
              </p>
            </div>
          </div>
        </div>
